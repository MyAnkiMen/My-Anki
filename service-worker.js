const CACHE_NAME = "my-anki-v4";
const APP_FILES = ["./", "./index.html", "./style.css", "./app.js", "./db.js", "./card-model.js", "./card-json.js", "./srs.js", "./study-session.js", "./manifest.webmanifest", "./icons/icon.svg"];
